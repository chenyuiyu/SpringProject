...
public class dataLoader {
    ...
    private void loadSanGuoSha() {
        ...
        shuWuJiang.setPicture(shu);
        shuWuJiang.setName("鲍三娘");
        shuWuJiang.setTitle("南中武娘");
        shuWuJiang.addSkills(new skill[] {
        ...
        wuWuJiang.setPicture(wu);
        wuWuJiang.setName("孙鲁班");
        wuWuJiang.setTitle("为虎作伥");
        wuWuJiang.addSkills(new skill[] {
        ...
        qunWuJiang.setPicture(qun);
        qunWuJiang.setName("谋貂蝉");
        qunWuJiang.setTitle("离间计");
        qunWuJiang.addSkills(new skill[] {
        ...
        shenWuJiang.setPicture(shen);
        shenWuJiang.setName("神荀彧");
        shenWuJiang.setTitle("洞心先识");
        shenWuJiang.addSkills(new skill[] {
